...
"""Trollflow2 documentation build configuration."""
...
project = 'Trollflow2'
copyright = '2019, Pytroll Community'
author = 'Panu Lahtinen, Martin Raspaud, Adam Dybbroe'
...
latex_documents = [
    (master_doc, 'Trollflow2.tex', u'Trollflow2 Documentation',
     u'Pytroll', 'manual'),
]
...
man_pages = [
    (master_doc, 'trollflow2', u'Trollflow2 Documentation',
     [author], 1)
]
